SWEP.PrintName			= "METAL GEEEEEEEEAR"			
SWEP.Author			= "GeekyGamer14"
SWEP.Instructions		= "Left click - Shoot metal gear\nRight click - Shoot ladder"
SWEP.Spawnable = true
SWEP.AdminOnly = true
...
SWEP.ViewModel			= "models/Mechanics/gears/gear24x6.mdl"
SWEP.WorldModel			= "models/Mechanics/gears/gear24x6.mdl"
local ShootSound = Sound( "gear/metalgear.wav" )
--
...
function SWEP:PrimaryAttack()
	...
	self:ThrowChair( "models/Mechanics/gears/gear24x6.mdl" )
end
...
function SWEP:SecondaryAttack()
	...
	-- Call 'ThrowChair' on self with this model
	self:ThrowChair( "models/mechanics/solid_steel/step_beam_64.mdl" )

end

function SWEP:Reload()
	--PrintMessage(HUD_PRINTTALK, "i very much want the joj")
end
...
function SWEP:ThrowChair( model_file )
	...
	--
	ent:SetPos( self.Owner:EyePos() + ( self.Owner:GetAimVector() * 21 ) )
